...
IAR=gAR_SI_more_h*mAR*(V-VAR_SI) : amp * meter ** -2
...
Iran=sig_ranSI_more_h*randn(): amp * meter ** -2 (constant over dt)
...
gAR_SI_more_h=75 * msiemens * cm **-2
VAR_SI=-35*mV

sig_ranSI_more_h=0.05* mamp * cm **-2*0
...
if __name__=='__main__' :
    ...
    SI=NeuronGroup(1,eq_SI_FEF,threshold='V>-20*mvolt',refractory=3*ms,method='rk4')
